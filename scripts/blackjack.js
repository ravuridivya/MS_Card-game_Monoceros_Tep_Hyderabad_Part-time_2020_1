...
var textWrapper = document.querySelector('.title-name');
textWrapper.innerHTML = textWrapper.textContent.replace(/\S/g, "<span class='letter'>$&</span>");

anime.timeline({loop: true})         //header title animation
  .add({
    targets: '.title-name .letter',
    scale: [4,1],
    opacity: [0,1],
    translateZ: 0,
    easing: "easeOutExpo",
...
function display_balance() {
	bal.innerHTML="Account: Rs"+amount + "-/";
	//Retrive from browser storage
	document.getElementById('highScore').innerHTML="Highest Score :Rs"+localStorage.getItem("Score")+"-/";
	if (amount>=3000){//For new game chips are visible
		document.getElementById('rupee1').style.display="inline";
		document.getElementById('rupees10').style.display="inline";
		document.getElementById('rupees100').style.display="inline";
		document.getElementById('rupees500').style.display="inline";
	}
	if (amount<3000 && amount>1){
		document.getElementById('newGame_btn').style.display="none";
	}
	if(amount<1){
		document.getElementById('rupee1').style.display="none";
		document.getElementById('newGame_btn').style.display="inline";
	}
	if(amount<10)
		document.getElementById('rupees10').style.display="none";
	if(amount<100)
		document.getElementById('rupees100').style.display="none";
	if(amount<500)
		document.getElementById('rupees500').style.display="none";
	if(amount>=1)
		document.getElementById('rupee1').style.display="inline";
	if(amount>=10)
		document.getElementById('rupees10').style.display="inline";
...
function bet_amount(betAmount) {
	bet.innerHTML="Bet Money: Rs"+betAmount + "-/";		
}
...
function noMoreBets() {
	document.getElementById('rupee1').setAttribute('disabled', true);
	document.getElementById('rupees10').setAttribute('disabled', true);
	document.getElementById('rupees100').setAttribute('disabled', true);
	document.getElementById('rupees500').setAttribute('disabled', true);
}
function startBets(){
	document.getElementById('rupee1').disabled=false;
	document.getElementById('rupees10').disabled=false;
	document.getElementById('rupees100').disabled=false;
	document.getElementById('rupees500').disabled=false;
}
